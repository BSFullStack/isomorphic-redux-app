...
(function() {
    ...
    Uploader = (function(_super) {
        ...
        Uploader.prototype.opts = {
            ...
            params: null,
            connectionCount: 3,
            leaveConfirm: '姝ｅ湪涓婁紶鏂囦欢锛屽鏋滅寮€涓婁紶浼氳嚜鍔ㄥ彇娑�'
        };
...
(function() {
        ...
        InputManager.prototype._onPaste = function(e) {
            ...
            if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items && e.originalEvent.clipboardData.items.length > 0) {
                ...
                if (/^image\//.test(pasteItem.type)) {
                    ...
                    if (!imageFile.name) {
                        imageFile.name = "鏉ヨ嚜鍓创鏉跨殑鍥剧墖.png";
                    }
                    uploadOpt = {};
    ...
    TitleButton = (function(_super) {
        ...
        TitleButton.prototype.title = '鏍囬鏂囧瓧';
    ...
    BoldButton = (function(_super) {
        ...
        BoldButton.prototype.title = '鍔犵矖鏂囧瓧';
    ...
    ItalicButton = (function(_super) {
        ...
        ItalicButton.prototype.title = '鏂滀綋鏂囧瓧';
    ...
    UnderlineButton = (function(_super) {
        ...
        UnderlineButton.prototype.title = '涓嬪垝绾挎枃瀛�';
    ...
    UnorderListButton = (function(_super) {
        ...
        UnorderListButton.prototype.title = '鏃犲簭鍒楄〃';
    ...
    BlockquoteButton = (function(_super) {
        ...
        BlockquoteButton.prototype.title = '寮曠敤';
    ...
    CodeButton = (function(_super) {
        ...
        CodeButton.prototype.title = '选择程序语言';
    ...
    LinkButton = (function(_super) {
        ...
        LinkButton.prototype.title = '鎻掑叆閾炬帴';
    ...
    LinkPopover = (function(_super) {
        ...
        LinkPopover.prototype._tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>鏂囨湰</label>\n    <input class=\"link-text\" type=\"text\"/>\n    <a class=\"btn-unlink\" href=\"javascript:;\" title=\"鍙栨秷閾炬帴\" tabindex=\"-1\"><span class=\"fa fa-unlink\"></span></a>\n  </div>\n  <div class=\"settings-field\">\n    <label>閾炬帴</label>\n    <input class=\"link-url\" type=\"text\"/>\n  </div>\n</div>";
    ...
    ImageButton = (function(_super) {
        ...
        ImageButton.prototype.renderMenu = function() {
            ...
            createInput = function() {
                ...
                return $input = $('<input type="file" title="涓婁紶鍥剧墖" name="file" accept="image/*">').appendTo($uploadItem);
            };
            createInput();
        ...
        ImageButton.prototype._initUploader = function() {
            ...
            this.editor.uploader.on('beforeupload', function(e, file) {
                ...
                return _this.editor.uploader.readImageFile(file.obj, function(img) {
                    ...
                    prepare = function() {
                        var $progress;
                        _this.popover.srcEl.val('姝ｅ湪涓婁紶...');
    ...
    ImagePopover = (function(_super) {
        ...
        ImagePopover.prototype._initUploader = function() {
            ...
            createInput = function() {
                ...
                return _this.input = $('<input type="file" title="涓婁紶鍥剧墖" name="file" accept="image/*">').appendTo($uploadBtn);
            };
            createInput();
    ...
    IndentButton = (function(_super) {
        ...
        IndentButton.prototype.title = '鍚戝彸缂╄繘锛圱ab锛�';
    ...
    OutdentButton = (function(_super) {
        ...
        OutdentButton.prototype.title = '鍚戝乏缂╄繘锛圫hift + Tab锛�';
    ...
    TableButton = (function(_super) {
        ...
        TableButton.prototype.title = '琛ㄦ牸';
        ...
        TableButton.prototype.renderMenu = function() {
            var _this = this;
            $('<div class="menu-create-table">\n</div>\n<div class="menu-edit-table">\n  <ul>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteRow"><span>鍒犻櫎琛�</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowAbove"><span>鍦ㄤ笂闈㈡彃鍏ヨ</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowBelow"><span>鍦ㄤ笅闈㈡彃鍏ヨ</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteCol"><span>鍒犻櫎鍒�</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColLeft"><span>鍦ㄥ乏杈规彃鍏ュ垪</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColRight"><span>鍦ㄥ彸杈规彃鍏ュ垪</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteTable"><span>鍒犻櫎琛ㄦ牸</span></a></li>\n  </ul>\n</div>').appendTo(this.menuWrapper);
    ...
    StrikethroughButton = (function(_super) {
        ...
        StrikethroughButton.prototype.title = '鍒犻櫎绾挎枃瀛�';
